...
export default function ManageContactsModal({ group, isOpen, onClose, onSave }: ManageContactsModalProps) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] flex flex-col">
                <div className="flex items-center justify-between p-6 border-b">
                    <div>
                        <h2 className="text-lg font-semibold text-gray-900">Gerenciar Contatos</h2>
                    ...
                    <div className="flex-1 overflow-auto border border-gray-200 rounded-md">
                        {loading ? (
                            ...
                            <div className="p-4 text-center text-gray-500">
                                {search ? "Nenhum contato encontrado com essa busca" : "Nenhum contato disponível"}
                            </div>
                        ) : (
