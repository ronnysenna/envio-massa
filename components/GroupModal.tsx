        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
                ...
                <div className="p-6 space-y-4">
                    <div>
                        <label htmlFor="group-nome" className="block text-sm font-medium text-gray-700 mb-1">
                            Nome *
                        </label>
                        <input
                            id="group-nome"
                    ...
                    <div>
                        <label htmlFor="group-descricao" className="block text-sm font-medium text-gray-700 mb-1">
                            Descrição
                        </label>
                        <textarea
                            id="group-descricao"
